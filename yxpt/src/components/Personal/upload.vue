    ...
    methods: {
        ...
        upload() {
            ...
            new Promise(function(resolve, reject) {
                ...
                client.setRequestHeader('uuid', window.sessionStorage.getItem('uuid'));
                client.setRequestHeader('token', window.sessionStorage.getItem('token'));
                client.setRequestHeader('platform', '2');
                client.setRequestHeader('systemId', '2');
